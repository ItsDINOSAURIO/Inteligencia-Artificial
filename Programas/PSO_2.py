...
num_variables = 7 
c1 ,c2= 1,1 #coeficiente de aceleración, #coeficiente poblacional 
...
for i in range(0,poblacion):
    ...
    individuo[i]['posicion'] = np.random.uniform(var_min,var_max,num_variables)*.01
    # print(individuo[i]['posicion'])
