...
class metro:
    ...
    def mapa(self):
        ...
        for nodo,(x,y) in self.coords_norm.items():
            self.canvas.create_oval(x-5,y-5,x+5,y+5,fill = "purple", outline = "white")
        ...
        self.lista_inicio = list(self.estaciones.values())  # Obtiene los nombres de las estaciones
        ...
        self.lista1.delete(0, tk.END)  # Limpia cualquier elemento anterior
        for estacion in self.lista_inicio:
            self.lista1.insert(tk.END, estacion)  # Agrega cada estación
        ...
        self.main_frame.columnconfigure(0, weight=3)  # Más espacio para el mapa
        self.main_frame.columnconfigure(1, weight=1)  # Menos espacio para las listas
        self.main_frame.rowconfigure(0, weight=1)
        self.main_frame.rowconfigure(1, weight=7)
        self.main_frame.rowconfigure(2, weight=1)
        
        button = tk.Button(self.root, text="Cerrar", command=self.root.quit)
        button.pack(pady=10)
